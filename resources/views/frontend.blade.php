...
<section id="portfolio">
	...
	<div class="template">
		<ul class="bxslider2">
			<li class="first"><img src="asset('frontend/common/image/img1-1-tempalte.png')}}" class="img-responsive" alt=""></li>
			<li><img src="{{asset('frontend/common/image/img2-2-tempalte.png')}}" class="img-responsive" alt=""></li>
			<li><img src="{{asset('frontend/common/image/img3-3-tempalte.png')}}" class="img-responsive" alt=""></li>
			<li><img src="{{asset('frontend/common/image/img4-4-tempalte.png')}}" class="img-responsive" alt=""></li>
			<li><img src="{{asset('frontend/common/image/img5-5-tempalte.png')}}" class="img-responsive" alt=""></li>
			<li><img src="{{asset('frontend/common/image/img6-6-tempalte.png')}}" class="img-responsive" alt=""></li>
			<li><img src="{{asset('frontend/common/image/img7-7-tempalte.png')}}" class="img-responsive" alt=""></li>
			<li><img src="{{asset('frontend/common/image/img8-8-tempalte.png')}}" class="img-responsive" alt=""></li>
		</ul>
	...
	<div class="projects row">
		<figure style="display: inline-block;" class="mix all portfolio-item icons col-md-4 col-sm-12 wow fadeInLeft animated" data-wow-delay="0.3s">
			<img src="{{asset('frontend/common/image/img1-1-tempalte.png')}}" class="img-responsive" alt="">
		...
		<figure style="display: inline-block;" class="mix portfolio-item ui-kits col-md-4  col-sm-12 wow fadeInLeft animated" data-wow-delay="0.6s">
			<img src="{{asset('frontend/common/image/img2-2-tempalte.png')}}" class="img-responsive" alt="">
			<figcaption class="mask">
				<h3><a href="http://www.yubara-kikunoyu.com/" at="">Website yubara-kikunoyu</a></h3>
				<span>Description</span>
			</figcaption>
		</figure>
		<figure style="display: inline-block;" class="mix portfolio-item icons col-md-4  col-sm-12 wow fadeInLeft animated" data-wow-delay="0.9s">
			<img src="{{asset('frontend/common/image/img3-3-tempalte.png')}}" class="img-responsive" alt="">
			<figcaption class="mask">
				<h3><a href="http://www.hiruzen-hills.co.jp/" at="">Website hiruzen-hills</a></h3>
				<span>Description</span>
			</figcaption>
		</figure>
		<figure style="display: inline-block;" class="mix portfolio-item icons col-md-4  col-sm-12 wow fadeInLeft animated" data-wow-delay="1.2s">
			<img src="{{asset('frontend/common/image/img4-4-tempalte.png')}}" class="img-responsive" alt="">
			<figcaption class="mask">
				<h3><a href="http://www.okaken.net" at="">Website okaken</a></h3>
				<span>Description</span>
			</figcaption>
		</figure>
		<figure style="display: inline-block;" class="mix portfolio-item icons col-md-4  col-sm-12 wow fadeInLeft animated" data-wow-delay="1.5s">
			<img src="{{asset('frontend/common/image/img5-5-tempalte.png')}}" class="img-responsive" alt="">
			<figcaption class="mask">
				<h3><a href="http://www.fujitaya-fff.jp/" at="">Website fujitaya-fff</a></h3>
				<span>Description</span>
			</figcaption>
		</figure>
		<figure style="display: inline-block;" class="mix portfolio-item icons col-md-4  col-sm-12 wow fadeInLeft animated" data-wow-delay="1.8s">
			<img src="{{asset('frontend/common/image/img6-6-tempalte.png')}}" class="img-responsive" alt="">
			<figcaption class="mask">
				<h3><a href="http://www.nppc.co.jp" at="">Website nppc</a></h3>
				<span>Description</span>
			</figcaption>
		</figure>
...
<!-- Start  section -->
	<?php $recruit = 'frontend/element/locale/'.$locale.'/recruit';?>
	@include($recruit)
<!-- End contact section -->
<!-- Start  section -->
