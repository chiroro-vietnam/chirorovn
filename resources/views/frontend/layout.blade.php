...
<head>
	...
	<script type="text/javascript" src="common/js/top.js"></script>
		<script src="common/js/analytics.js" async=""></script><script>
	...
	<script src="common/js/telemetry.js">
	</script><script src="common/js/menu_handler.js"></script>
</head>
<body>
	<header>
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img src="common/image/logo.png" alt=""></a>
				</div>
				<div class="collapse navbar-collapse navbar-right" id="navbar-collapse">
					<div class="language"><span><a href="index.html/vn"><img title="" src="common/image/vn.png"/></a></span><span><a href="index.html/jp"><img title="" src="common/image/jp.png"/></a></span><span><a href="index.html/en"><img title="" src="common/image/gb.png"/></a></span></div>
					<ul class="nav navbar-nav">
						<li><a data-scroll="" href="index.html">Trang chủ</a></li>
						<li><a data-scroll="" href="index.html#services">Dịch vụ</a></li>
						<li><a data-scroll="" href="index.html#blog">Template</a></li>
						<li><a data-scroll="" href="index.html#about">Thông tin</a></li>
						<li><a data-scroll="" href="index.html#position">Vị trí</a></li>
						<li><a data-scroll="" href="index.html#recruit">Tuyển dụng</a></li>
						<li><a data-scroll="" href="index.html#contact">Liên hệ</a></li>
					</ul>
				</div>
			</div>
		</nav>
	...
	<ul class="bxslider">
		<li class="first"><img src="common/image/top-img7.jpg" alt=""></li>
		<li><img src="common/image/top-img8.jpg" alt=""></li>
	</ul>
				...
				<div class="col-md-4">
					<div style="visibility: visible; animation-name: fadeInUp;" class="service-item text-right wow fadeInUp animated">
						...
						<div class="service-icon">
							<i><img title="" src="common/image/icon-design.png" /></i>
						</div>
					</div>
					<div style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;" class="service-item text-right wow fadeInUp animated" data-wow-delay="0.1s">
						...
						<div class="service-icon">
							<i><img title="" src="common/image/icon-translate.png" /></i>
						</div>
					</div>
				</div>
				<div class="col-md-4 text-center">
					<img src="common/image/phone.png" alt="Phone" class="img-responsive" >
				</div>
				<div class="col-md-4">
					<div style="visibility: visible; animation-name: fadeInUp;" class="service-item text-left wow fadeInUp animated">
						...
						<div class="service-icon">
							<i><img title="" src="common/image/icon-code.png" /></i>
						</div>
					</div>
					<div style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;" class="service-item text-left wow fadeInUp animated" data-wow-delay="0.1s">
						...
						<div class="service-icon">
							<i><img title="" src="common/image/icon-apps.png" /></i>
						</div>
					</div>
				</div>
			</div>
...
<section id="blog" class="dark">
	...
	<ul class="bxslider template">
		...
		<li><img src="common/image/img2-tempalte.png" class="img-responsive" alt=""></li>
		<li><img src="common/image/img3-tempalte.png" class="img-responsive" alt=""></li>
		<li><img src="common/image/img4-tempalte.png" class="img-responsive" alt=""></li>
		<li><img src="common/image/img5-tempalte.png" class="img-responsive" alt=""></li>
		<li><img src="common/image/img6-tempalte.png" class="img-responsive" alt=""></li>
		<li><img src="common/image/img7-tempalte.png" class="img-responsive" alt=""></li>
		<li><img src="common/image/img8-tempalte.png" class="img-responsive" alt=""></li>
	</ul>
	<div class="blog-items clearfix">
		<div class="row">
			<div style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;" class="blog-item col-md-3 wow fadeInLeft animated" data-wow-delay="0.4s">
				<img src="common/image/img1-tempalte.png" class="img-responsive" alt="">
			</div>
			<div style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;" class="blog-item col-md-3 wow fadeInLeft animated" data-wow-delay="0.4s">
				<img src="common/image/img2-tempalte.png" class="img-responsive" alt="">
				
			</div>
			<div style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;" class="blog-item col-md-3 wow fadeInLeft animated" data-wow-delay="0.4s">
				<img src="common/image/img3-tempalte.png" class="img-responsive" alt="">
			</div>
			<div style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;" class="blog-item col-md-3 wow fadeInLeft animated" data-wow-delay="0.4s">
				<img src="common/image/img4-tempalte.png" class="img-responsive" alt="">
			</div>
		</div>
		<div class="row" style="margin-top:30px;">
			<div style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;" class="blog-item col-md-3 wow fadeInLeft animated" data-wow-delay="0.4s">
				<img src="common/image/img5-tempalte.png" class="img-responsive" alt="">
			</div>
			<div style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;" class="blog-item col-md-3 wow fadeInLeft animated" data-wow-delay="0.4s">
				<img src="common/image/img6-tempalte.png" class="img-responsive" alt="">
			</div>
			<div style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;" class="blog-item col-md-3 wow fadeInLeft animated" data-wow-delay="0.4s">
				<img src="common/image/img7-tempalte.png" class="img-responsive" alt="">
			</div>
			<div style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;" class="blog-item col-md-3 wow fadeInLeft animated" data-wow-delay="0.4s">
				<img src="common/image/img8-tempalte.png" class="img-responsive" alt="">
			</div>
		</div>
	</div>
</section>
...
<footer>
	<div class="container">
		<p class="copyright">
			(c) Chiroro-Net Viet Co.,Ltd.
		</p>
		<!--<ul class="social">
			<li style="visibility: visible; animation-name: bounceIn;" class="wow bounceIn animated"><a href="http://www.facebook.com/zoomtovietnam/" target="_blank"><i class="fa fa-facebook"></i></a></li>
			<li style="visibility: visible; animation-delay: 0.1s; animation-name: bounceIn;" class="wow bounceIn animated" data-wow-delay="0.1s"><a href="#" target="_blank"><i class="fa fa-twitter"></i></a></li>
			<li style="visibility: visible; animation-delay: 0.2s; animation-name: bounceIn;" class="wow bounceIn animated" data-wow-delay="0.2s"><a href="#" target="_blank"><i class="fa fa-dribbble"></i></a></li>
			<li style="visibility: visible; animation-delay: 0.3s; animation-name: bounceIn;" class="wow bounceIn animated" data-wow-delay="0.3s"><a href="#" target="_blank"><i class="fa fa-behance"></i></a></li>
			<li style="visibility: visible; animation-delay: 0.4s; animation-name: bounceIn;" class="wow bounceIn animated" data-wow-delay="0.4s"><a href="#" target="_blank"><i class="fa fa-pinterest"></i></a></li>
			<li style="visibility: visible; animation-delay: 0.5s; animation-name: bounceIn;" class="wow bounceIn animated" data-wow-delay="0.5s"><a href="#" target="_blank"><i class="fa fa-google"></i></a></li>
		</ul>
		<a href="http://zoomtovietnam.com/index.html#home" data-scroll="" class="back-to-top"><i class="fa fa-chevron-up"></i></a>-->
	</div>
</footer>
<!-- End footer section -->
<!-- Load jQuery -->
...
<script type="text/javascript" src="common/js/jquery_002.js"></script>
<script type="text/javascript" src="common/js/jquery.js"></script>
<script type="text/javascript" src="common/js/wow.js"></script>
<script type="text/javascript" src="common/js/smooth-scroll.js"></script>
<script type="text/javascript" src="common/js/show.js"></script>
