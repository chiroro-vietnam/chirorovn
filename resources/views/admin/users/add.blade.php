            ...
            <div class="col-xs-12">
                ...
                {!! Form::open( ['method' => 'post', 'route' => 'admin.users.add', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data'] ) !!}
                    <div class="form-group {!! $errors->has('username') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="username" name="username" placeholder="{{trans('common.lbl_username')}}" class="col-xs-10 col-sm-5" autofocus/>                                            
                        </div>
                    ...
                    <div class="form-group {!! $errors->has('email') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="email" name="email" placeholder="{{trans('common.lbl_email')}}" class="col-xs-10 col-sm-5" autofocus/>                                            
                        </div>
                    ...
                    <div class="form-group {!! $errors->has('password') ? 'has-error' : '' !!}">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> {{trans('common.lbl_password')}}<span class="icnMust">{{trans('common.icnMust')}}</span></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group {!! $errors->has('confirm_password') ? 'has-error' : '' !!}">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> {{trans('common.lbl_confirm_password')}}<span class="icnMust">{{trans('common.icnMust')}}</span></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group {!! $errors->has('name') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="name" name="name" placeholder="{{trans('common.lbl_name')}}" class="col-xs-10 col-sm-5" autofocus/>                                            
                        </div>
                    ...
                    @if(LaravelLocalization::getCurrentLocaleName() == 'Japanese')
                     ...
                     <div class="form-group {!! $errors->has('furigana') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="furigana" name="furigana" placeholder="{{trans('common.lbl_furigana')}}" class="col-xs-10 col-sm-5" autofocus/>                                            
                        </div>
