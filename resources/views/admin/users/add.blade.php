...
<!--breadcrumb-->
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">{{trans('common.lbl_add')}}</li>
        </ul>
    </div>
 <!-- /.breadcrumb -->
    <div class="page-content">
        ...
        <div class="page-header">
            <h1>{{trans('common.lbl_user_add')}}</h1>
        </div><!-- /.page-header -->
                        ...
                        {!! Form::open( ['method' => 'post', 'route' => 'admin.users.add', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data'] ) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="username" id="username" class="form-control parsley-error col-md-7 col-xs-12" placeholder="{{trans('common.lbl_username')}}" autofocus value="{{Input::old('username')}}">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="email" id="email" class="form-control parsley-error col-md-7 col-xs-12" placeholder="{{trans('common.lbl_email')}}" autofocus value="{{Input::old('email')}}">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="password" name="password" id="password" class="form-control parsley-error col-md-7 col-xs-12" placeholder="{{trans('common.lbl_password')}}" autofocus value="{{Input::old('password')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="password" name="confirm_password" id="confirm_password" class="form-control parsley-error col-md-7 col-xs-12" placeholder="{{trans('common.lbl_confirm_password')}}" autofocus value="{{Input::old('confirm_password')}}">
                            ...
                            <div class="form-group">
                                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">{{trans('common.lbl_name')}} <span class="icnMust">{{trans('common.icnMust')}}</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="full_name" id="full_name" class="form-control parsley-error col-md-7 col-xs-12" placeholder="{{trans('common.lbl_name')}}" autofocus value="{{Input::old('full_name')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="furigana" id="furigana" class="form-control parsley-error col-md-7 col-xs-12" placeholder="{{trans('common.lbl_furigana')}}" autofocus value="{{Input::old('furigana')}}">
                            ...
                            <div class="form-group">
                                <div class="col-md-3 col-sm-3 col-xs-9 col-md-offset-3">
                                    <button type="submit" class="width-45 pull-right btn btn-sm btn-info">
                                        <span class="bigger-110">{{trans('common.btn_user_save')}}</span>
