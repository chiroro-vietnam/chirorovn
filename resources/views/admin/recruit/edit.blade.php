...
<!--breadcrumb-->
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">{{trans('common.lbl_recruit_edit')}}</li>
        </ul>
    </div>
 <!-- /.breadcrumb -->
    <div class="page-content">
        ...
        <div class="row">                        
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                {!! Form::open( ['method' => 'post', 'route' => ['admin.recruit.edit', $recruit->id], 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data'] ) !!}
                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="position" id="position" class="form-control parsley-error col-md-7 col-xs-12" placeholder="{{trans('common.lbl_recruit_position')}}" autofocus value="{{$recruit->position}}">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <textarea class="form-control" rows="10" cols="50" id="content" name="content" value="{{$recruit->content}}">
                                        {{$recruit->content}}      
                                    </textarea>
                                    <ul class="parsley-errors-list filled" id="parsley-id-3888">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1 col-sm-2 col-xs-2">
                                    <input type="text" style="text-align: center;" name="order" id="order" class="form-control parsley-error col-md-1 col-xs-1" placeholder="{{trans('common.lbl_recruit_order')}}" value="{{$recruit->order}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-4">    
                                        <select  class="col-xs-3" id="publish" name="publish">                                            
                                            <option value="0" @if($recruit->publish == 0) selected="selected" @endif >Disable</option>
                                            <option value="1" @if($recruit->publish == 1) selected="selected" @endif>Enable</option>
                                        </select>
